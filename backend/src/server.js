...
app.use(clerkMiddleware())//this has auth  field to request object: req.auth()
...
//     res.status(200).json({
//         msg:"this is the books endpoints"
//     });
// });
...
//     res.status(200).json({msg:"this is a protested route"});
